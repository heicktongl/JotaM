...
export const buildProductCheckoutMessage = (
    ...
    let msg = `🛍️ *Novo Pedido JotaM!*\n\n`;
    msg += `Olá, vim pelo JotaM e acabei de fazer um pedido contigo. Seguem os detalhes:\n\n`;
