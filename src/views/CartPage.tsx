      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-neutral-200 bg-white p-4 pb-8 shadow-[0_-10px_40px_rgba(0,0,0,0.05)]">
        <div className="mx-auto max-w-3xl">
          <button
            ...
            className="flex w-full h-14 items-center justify-center gap-2 rounded-2xl bg-[#25D366] px-6 font-bold text-white shadow-lg shadow-green-600/30 transition-all hover:bg-[#20BD5A] active:scale-[0.98]"
          >
            Revisar e Enviar ao Vendedor
            <ArrowRight size={20} />
          </button>
        </div>
      </div>
